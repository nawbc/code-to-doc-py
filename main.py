...
getAllFile( r'C:\\Users\\sewer\\Desktop\\my_soft\\pure\\lib', fileList)
print('文件数量为： ',len(fileList))

def getJavaFile(fileList):
    for file in fileList:
        if not file.endswith('.dart'): # 删除不是 .java 文件的格式
...
def saveDocFile():
    ...
    save_file = r'C:\\Users\\sewer\\Desktop\\my_soft\\pure\\source.doc'
    codeNum = 0
